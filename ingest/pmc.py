...
_USER_AGENT = "central-dogma/0.1 (https://github.com/yjkong04/central-dogma)"
...
class Figure:
    ...
    image_bytes: bytes | None = None  # local figure crop (PDF path); PMC uses image_uri instead
